locals {
  ...
  // output locals
  name        = !local.is_passthrough ? google_dns_managed_zone.this[0].name : local.domain_name
  zone_id     = !local.is_passthrough ? data.ns_workspace.this.block_ref : local.domain_zone_id
